...
<div class="grid">
    ...
    <main>
        ...
        <article class="about-me-container">
            ...
            <p class="about-me-text">Lorem ipsum dolor sit amet consectetur adipiscing elit. 
    ...
    <footer class="view-transition-to">
...
/* ---------------------------------------------      GRID - GRID-AREA NAMING / ORDER     -------------------------------------------------*/

@layer grid-naming-order{
    /* GRID Template areas */
